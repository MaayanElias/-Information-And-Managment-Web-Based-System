<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="ShowStudentMessages.aspx.cs" Inherits="ShowStudentMessages" %>
   ...
   <div class="sectionTitle text-center">
    ...
    <div class="container content">
        ...
        <div class="upperGRDWsection">
            <div class="btn-group btn-group-sm selectMail" role="group" aria-label="send-recieve mail">
            ...
            <button type="button" class="btn btn-info btn-sm createMessage" data-toggle="modal" data-target="#createMessageModal">צור הודעה חדשה</button>
        ...
        <div>
            ...
            <asp:SqlDataSource ID="InMailStudentDS" runat="server" ConnectionString="<%$ ConnectionStrings:studentDBConnectionString %>" SelectCommand="select msg_id,  man_FirstName + ' ' +  man_LastName , msg_subject ,msg_date ,msg_hasRead,msg_content
from ManagerMessages inner join Manager on msg_fromManagerId=Man_id where msg_toStudentId = @current_stu_id and msg_IsDeletedForStudent=0 order by msg_id desc"></asp:SqlDataSource>

        </div>

        <div>
            <asp:GridView ID="InMailGRDW" CssClass="grid" runat="server" Style="text-align: center; margin: 0 auto; margin-top: 20px;margin-bottom:70px; text-align: center; width: 100%"  DataSourceID="InMailStudentDS" OnRowDataBound="InMailGRDW_RowDataBound" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal">
        ...
        <div>
            ...
            <asp:SqlDataSource ID="StudentMessagesDS" runat="server" ConnectionString="<%$ ConnectionStrings:studentDBConnectionString %>" SelectCommand="select msg_id,  Man_FirstName + ' ' +  Man_LastName , msg_subject ,msg_date ,msg_hasRead,msg_content
from StudentMessages inner join Manager on msg_toManagerId=Man_id where msg_fromStudentId = @stu_id and msg_isDeletedForStudent=0 AND system_msg=0 order by msg_id desc  "></asp:SqlDataSource>

        </div>

        <div>
            <asp:GridView ID="StudentMessagesGRDW" CssClass="grid" OnRowDataBound="StudentMessagesGRDW_RowDataBound" runat="server" Style="margin: 0 auto; margin-top: 20px; text-align: center; width: 100%" DataSourceID="StudentMessagesDS"  AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" >
                        <AlternatingRowStyle BackColor="#F7F7F7" />
                <RowStyle Height="30px" />
                <Columns>
                    <asp:TemplateField ShowHeader="False">
