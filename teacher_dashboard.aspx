<%@ Page Title="" Language="C#" MasterPageFile="~/TeacherMasterPage.master" AutoEventWireup="true" CodeFile="teacher_dashboard.aspx.cs" Inherits="teacher_dashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type='text/javascript'>
        ...
        toastr.options.onclick = function () { window.location.replace("ShowTeacherMessages.aspx"); }
        ...
        <div class="row">
            <div class="col-lg-7 no-margin" style="display: inline-block">
                ...
                <div style="text-align: center">
                    <img id="indexMap" src="images/teacher_line_mapindex.jpg" />
                </div>
                    ...
                    <div id="showTigburPopupPopupDiv" style="display: none; text-align: center;">
                        ...
                        <table runat="server" dir="rtl">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="add_Bakasha" CssClass="btn btn-sm btn-danger btn-width" runat="server" Text="בטל השתתפות" />
                                    <br />
                                </td>
                        ...
                        <div style="margin-top: 15px;" class="text-center">
                            ...
                            <asp:TextBox ID="reasonTB" CssClass="form-control RTLclass" runat="server" placeholder="הכנס סיבת ביטול"></asp:TextBox>
                        </div>
            ...
            <div class="col-lg-5 no-margin" style="display: inline">
                ...
                <div class="rtl">
                    ...
                    <asp:SqlDataSource ID="upcomingLessonsForTeacherDS" runat="server" ConnectionString="<%$ ConnectionStrings:studentDBConnectionString %>" SelectCommand="select top(8) actLes_date,Pro_Title,Les_StartHour,Les_EndHour,Les_MaxQuan,quantity from Lesson inner join ActualLesson on Les_Id = ActLes_LesId inner join Profession on Les_Pro_Id=Pro_Id where ActLes_date >= GETDATE()-1  AND actls_cancelled=0 AND Les_Tea_Id= @current_tea_id order by ActLes_date"></asp:SqlDataSource>

                    <asp:GridView ID="upcomingLessonsForTeacherGRDW" EmptyDataText="טרם נקבעו עבורך תגבורים" CssClass="grid" runat="server" EnableViewState="false" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Horizontal" Style="margin: 0 auto; margin-top: 20px; margin-bottom: 50px; text-align: center; width: 100%" DataSourceID="upcomingLessonsForTeacherDS">
                ...
                <div id="messages_section" style="position: relative; top: -30px;">
                    ...
                    <div class="rtl" >
                        <asp:SqlDataSource ID="InMailTeacherDS" runat="server" ConnectionString="<%$ ConnectionStrings:studentDBConnectionString %>" SelectCommand="select top(5) msg_id,  man_FirstName + ' ' +  man_LastName , msg_subject ,msg_date ,msg_hasRead,msg_content from ManagerMessagesToTeachers inner join Manager on msg_fromManagerId=Man_id where msg_toTeacherId = @current_tea_id order by msg_id desc"></asp:SqlDataSource>
                        <asp:GridView ID="InMailGRDW" EmptyDataText="אין הודעות להצגה" CssClass="grid" runat="server" EnableViewState="false" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Horizontal" Style="margin: 0 auto; margin-top: 20px; text-align: center; width: 100%" DataSourceID="InMailTeacherDS" OnRowDataBound="InMailGRDW_RowDataBound" AllowPaging="True">
                            <AlternatingRowStyle BackColor="#F7F7F7" />
                            <Columns>
