<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AddLesson.aspx.cs" Inherits="AddLesson" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        function validateMaxQuanLength(oSrc, args) {
            if (args.Value <= 30)
                args.IsValid = true;
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="homeContactContent">
                    ...
                    <div class="form-group">
                        <asp:DropDownList ID="dayDDL" runat="server" Style="text-align: right" CssClass="form-control border-color-4 tb" DataTextField="Ave_TeaId" DataValueField="Ave_TeaId" AutoPostBack="true " OnSelectedIndexChanged="dayDDL_SelectedIndexChanged">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                ControlToValidate="maxQuanTB"
                                ErrorMessage="שדה זה הינו שדה חובה"
                                ForeColor="Red">
                            <img class="fieldError" src="images/requiredField.png"  title="שדה זה הינו שדה חובה" />
                        </asp:RequiredFieldValidator>

                            <asp:CustomValidator ID="maxQuanTBCustomVal" runat="server"
                                ControlToValidate="maxQuanTB"
                                ErrorMessage="הכמות המקסימלית לתגבור הינה 30"
                                ClientValidationFunction="validateMaxQuanLength">
                                <img class="fieldError" src="images/requiredField.png"  title="הכמות המקסימלית לתגבור הינה 30"/>                     
                            </asp:CustomValidator>
                        </div>
                    </div>
                </div>
